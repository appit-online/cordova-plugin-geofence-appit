...
https://github.com/appit-online/cordova-plugin-geofence-appit
...
For android plugin broadcasting intent `com.appit.cordova.geofence.TRANSITION`. You can implement your own `BroadcastReceiver` and start listening for this intent.
...
<receiver android:name="YOUR_APP_PACKAGE_NAME.TransitionReceiver">
    <intent-filter>
        <action android:name="com.appit.cordova.geofence.TRANSITION" />
    </intent-filter>
</receiver>
```
...
```java
......
import com.appit.cordova.geofence.Gson;
import com.appit.cordova.geofence.GeoNotification;
...
- git clone https://github.com/appit-online/cordova-plugin-geofence-appit
...
© 2025 AppIT. All rights reserved
